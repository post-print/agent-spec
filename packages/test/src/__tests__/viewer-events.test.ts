...
it("viewer events › round-trips a text envelope as one NDJSON line", () => {
	const event = {
		type: "text" as const,
		suite: "smoke",
		scenario: "hello",
...
it("viewer events › round-trips loaded context files", () => {
	const event = {
...
it("viewer events › round-trips a setup status line", () => {
	const event = {
...
it("viewer events › round-trips a compare-arm tool event", () => {
	const event = {
		type: "tool" as const,
		suite: "judge",
...
it("viewer events › round-trips the authoritative scenario result", () => {
	const event = {
...
it("viewer events › ignores blank and invalid lines", () => {
